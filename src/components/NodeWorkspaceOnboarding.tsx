...
const STEPS: Step[] = [
  {
    title: '阶段 / 节点',
    body: '左侧按阶段（前期 → 设计 → 主体 → 水电 → 防水 → 瓦工 → 木工 → 油工 → 安装 → 软装家电 → 收尾）罗列了 60 多个节点。点击节点进入它的工作台。',
  },
  {
    title: '5 个 Tab',
    body: '每个节点都有 5 个 Tab：避坑要点、Checklist、采购记录、现场照片、施工笔记。所有的修改都自动保存到本地。',
  },
  {
    title: '改状态拖时间',
    body: '右上角可以切换状态（未开始 / 进行中 / 已完成 / 已跳过）。在「时间线」视图里还能直接拖拽节点条调整计划日期。',
  },
  {
    title: '快捷键',
    body: '⌘K 全局搜索；⌘N 新建采购；Esc 关闭弹窗。在「设置 → 节点模板管理」可以编辑默认节点模板。',
  },
]
  ...
  return (
    ...
    >
      <div style={{ padding: 20 }}>
        ...
        <h2 id="onboarding-title" style={{ margin: '0 0 8px', fontSize: 18 }}>
          {step + 1}. {cur.title}
        </h2>
